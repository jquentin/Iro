...
[CustomEditor(typeof(AnimatorAudioPack))]
public class AnimatorAudioPackEditor : Editor {
	...
	public override void OnInspectorGUI ()
	{
		...
		if (ac != null)
		{
			bool itemAdded = ((AnimatorAudioPack)serializedObject.targetObject).AddItem(ac, audioType);
			if (itemAdded)
