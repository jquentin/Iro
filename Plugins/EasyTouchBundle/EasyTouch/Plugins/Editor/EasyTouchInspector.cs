	...
	public override void OnInspectorGUI(){
		...
		if (t.showGestureInspector){
			HTGuiTools.BeginGroup();{
				...
				t.toleranceUnit = (EasyTouch.ToleranceUnit)EditorGUILayout.EnumPopup("Unit for stationary tolerance", t.toleranceUnit);
				t._StationaryTolerance = EditorGUILayout.FloatField("Stationary tolerance",t._StationaryTolerance);
